...
export default {
  ...
  methods: {
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.alamat && this.pesan.noTelpon) {
        ...
        .then(() => {
          ...
          this.$toast.success("Terimakasih, Barang Anda Segera Diproses", {
            type: "success",
            position: "top-right",
            duration: "3000",
            dismissible: true,
        ...
        this.$toast.error("Harus Melengkapi Data Dibawah Ini", {
          type: "error",
          position: "top-right",
          duration: "3000",
          dismissible: true,
